...
def access_records():
    ...
    registration_records_window_gui=window(registration_records_window, 'Registration Records')
    ...
    reg_rec_gui=window.label(reg_rec_l1, 'Please select whose data you want to access: ', 0, 0)
    
    options=['All Classes','Class 9th','Class 10th','Sam','Angel'] # Contains all names and classes
