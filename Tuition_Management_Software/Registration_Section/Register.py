...
def register_names():
    ...
    reg_l2_gui=window.label(reg_l2,'Class of student: ',1,0) #Class can be any other than 10, 11, 12 like 10th applied , therefore no combobox has been used with specific options.
    ...
    reg_l5_gui = window.label(reg_l5, 'Contact numbers( separated by commas ): ', 4, 0)
