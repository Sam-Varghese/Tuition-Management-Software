...
def google_window():
    ...
    google_win_b1=ttk.Button(google_win_lf1, text='Google-Chrome', cursor='wait')
    google_win_b1.grid(row=0,column=0,padx=5,pady=5)
    
    # Google Meet button
    
    google_win_b2=ttk.Button(google_win_lf1, text='Google-Meet', cursor='wait')
    google_win_b2.grid(row=0,column=1,padx=5,pady=5)
    
    # Google Classroom button
    
    google_win_b3=ttk.Button(google_win_lf1, text='Google-Classroom', cursor='wait')
    google_win_b3.grid(row=0, column=2, padx=5, pady=5)
    
    # G-Mail button
    
    google_win_b4=ttk.Button(google_win_lf1, text='G Mail', cursor='wait')
    google_win_b4.grid(row=0, column=3, padx=5, pady=5)
    
    # Google Sheets button
    
    google_win_b5=ttk.Button(google_win_lf1, text='Google-Sheets', cursor='wait')
    google_win_b5.grid(row=1, column=0, padx=5, pady=5)
    
    # Google photos button
    
    google_win_b6=ttk.Button(google_win_lf1, text='Google-Photos', cursor='wait')
    google_win_b6.grid(row=1, column=1, padx=5, pady=5)
    
    # Google Maps button
    
    google_win_b7=ttk.Button(google_win_lf1, text='Google-Maps', cursor='wait')
    google_win_b7.grid(row=1,column=2, padx=5, pady=5)
    
    # Google Forms button
    
    google_win_b8=ttk.Button(google_win_lf1, text='Google-Forms', cursor='wait')
    google_win_b8.grid(row=1,column=3,padx=5,pady=5)
    
    # Google calendar button
    
    google_win_b9=ttk.Button(google_win_lf1, text='Google-Calendar', cursor='wait')
    google_win_b9.grid(row=2,column=0,padx=5,pady=5)
    
    # Google Docs button
    
    google_win_b10=ttk.Button(google_win_lf1, text='Google-Docs', cursor='wait')
    google_win_b10.grid(row=2,column=1,padx=5,pady=5)
    
    # Google Slides button
    
    google_win_b11=ttk.Button(google_win_lf1, text='Google-Slides', cursor='wait')
    google_win_b11.grid(row=2,column=2,padx=5,pady=5)
    
    # Google Drive button
    
    google_win_b12=ttk.Button(google_win_lf1, text='Google-Drive', cursor='wait')
